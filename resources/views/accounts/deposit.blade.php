    ...
    <div class="flex flex-col gap-4">
        ...
        <div class="flex justify-center gap-4 px-4 mb-4">
            ...
            <button
                onclick="
            event.preventDefault();
            document.getElementById('deposit').value = 1000"
                class="px-4 py-2 rounded-lg bg-neutral-800 hover:bg-neutral-700">$1000.00</button>
        </div>
        <input id='deposit' placeholder="Enter desigred amount..." type="number" name='deposit'
            class="block w-full py-5 px-4 mt-2 mb-0 ml-0 mr-0 text-base border rounded-md border-neutral-600 placeholder-neutral-700 focus:outline-none focus:border-neutral-500 bg-neutral-950 @error('deposit') border-red-500  @enderror" />
        @error('deposit')
